    ...
    resources: {
        ...
        entity:{
            ...
            field_validation: {
                ...
                nome: 'Only letters and the following characters: _-.',
                about: 'Must contain only letters, numbers, spaces and basic punctuation',
                about_invalid_characters: 'Invalid characters',
                about_length: 'Must contain between 10 and 300 characters',
                workHours_invalid_format: 'Must contain only digits and may have optional spaces, hyphens or parentheses',
            },
        },
        menu:{
            region: 'Regions',
        ...
        route:{
            ...
            fields: {
                ...
                ativo: 'Active',
                stops: 'Stops',
                button_label_open: 'Routes Management',
                button_label_close: 'Close',
                button_label_add: 'Add Route',
            }
        },
        stop:{
            name: "Stops",
            edit_title: 'Edit Stop',
            create_title: "Create Stop",
            fields:{
                nome: 'Name',
                latitude: 'Latitude',
                longitude: 'Longitude'
