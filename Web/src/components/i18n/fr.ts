    ...
    resources: {
        ...
        entity:{
            ...
            field_validation: {
                ...
                phone: 'Doit être un numéro de téléphone valide: 00000000',
                about: 'Doit contenir entre 10 et 300 caractères',
                about_invalid_characters: 'Doit contenir uniquement des lettres, des chiffres, des espaces et une ponctuation de base',
                about_length: 'Doit contenir entre 10 et 300 caractères',
                workHours_invalid_format: "Doit contenir uniquement des chiffres et peut comporter des espaces, des traits d'union ou des parenthèses facultatifs",
            }
        },
        menu:{
            region: 'Régions',
        ...
        route:{
            name: "Route",
            edit_title: 'Modifier la route',
            create_title: "Créer une route",
            single: "Route",
            driverroute: "Itinéraires de travail",
            fields: {
                nome: 'Nom',
                region: 'Région',
                entity: 'Entité',
                ativo: 'Actif',
                stops: 'Arrêts',
                button_label_open: 'Gestion des arrêts',
                button_label_close: 'Fermer',
                button_label_add: 'Ajouter un arrêt',
            }
        },
        stop:{
            name: "Arrêts",
            edit_title: "Modifier l'arrêt",
            create_title: "Créer un arrêt",
            fields:{
                nome: 'Nom',
                latitude: 'Latitude',
                longitude: 'Longitude'
